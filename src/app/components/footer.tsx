...
export default function Footer() {
    return <footer className="p-2.5 bg-white border-t border-t-slate-300 z-30 dark:bg-slate-800 dark:border-t-slate-600">
        <div className="w-1200 h-[34px] flex justify-between items-center mx-auto font-medium text-slate-400/60 dark:text-slate-500">
